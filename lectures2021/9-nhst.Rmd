...
We have a normal distribution for which we have a score of interest (new applicant, $\bar{X}$ ), we know the mean of the population (the before times, M), the standard deviation of the before times, so we can get the standard deviation (SEM). 
...
But rarely will you have access to all the data in your population, so you won't be able to calculate the population standard deviation. What will you do? We still have our population mean of 5.3, but now let's say we *only* have the **sample** standard deviation...
