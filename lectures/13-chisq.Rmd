...
- Odds(Dropped Out | < High School = (20/40) / (1-20/40) = 1
- Odds(Dropped Out | High School = (15/40) / (1-15/40) = .6

--

- Odds Ratio = 1 / .6 = 1.66

*The odds of dropping out of the study rather than remaining in the study when they did not complete high school are 1.66 times the odds of dropping out if they completed high school, but not college*
...
Practice:
- Work through the full chi-square test on your own time. You should get .008. See if you're right!
