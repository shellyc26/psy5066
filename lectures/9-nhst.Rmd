...
- A $z$-statistic or $t$-statistic summarizes how unusual the sample estimate of a mean compared to the value of the mean as specified by the null hypothesis.
...
**Type II error** is when the null is truly false (aka the alternative is better), but it is still less than our critical value, so we *incorrectly* retain the null when in fact we should reject it. A false negative. 
