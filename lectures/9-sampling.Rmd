...
.left-column[
.small[
If N is not “sufficiently large?”  The normal assumes we know the population mean and standard deviation. But we don’t. We only know the sample mean and sd, and those have some uncertainty about them. 
