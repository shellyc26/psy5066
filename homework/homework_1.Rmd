...
Please complete this assignment using the RMarkdown file provided (<a href="homework_1.Rmd" download="homework_1.Rmd">download here</a>). Be sure to include your name in the preamble. When you turn in the assignment, include **_both_** the .Rmd and knitted .html files. Please turn in both documents to the **ASSIGNMENTS** page *and* the **PEER REVIEW DISCUSSION** on Canvas.
