...
- Please turn in both documents (the .Rmd and the .html) to the **ASSIGNMENTS** page on Canvas.
...
![](selfesteem.png)
 ...
 - For every main effect(s) and interaction(s), write one sentence indicating what they found. Please describe the interaction(s) both ways. You can assume any difference is "real" or "significant".
